...
export const books: Book[] = [
  ...
  },
  {
    ...
    description: "นิยายสั้นต้นฉบับหนึ่งหน้า ว่าด้วยนักซ่อมโคมไฟและเมืองที่กลับมาฟังความทรงจำของกันและกัน",
    price: 189,
    category: "Fantasy",
    pages: 1,
    accent: "#7c6cff",
  ...
  },
  {
    ...
    description: "คู่มืออ่านสั้นหนึ่งหน้า เริ่มนิสัยจากขั้นเล็ก ๆ ลดแรงตัดสินใจ และทบทวนระบบให้พอดีกับชีวิต",
    price: 229,
  ...
  },
  {
    ...
    description: "เรื่องสั้นต้นฉบับหนึ่งหน้า เมื่อคนแปลกหน้าหลบฝนเข้าร้านกาแฟก่อนปิด และพบความกล้าสำหรับการเริ่มใหม่",
    price: 159,
